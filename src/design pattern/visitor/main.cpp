...
class UpVisitor : public Visitor {
	void visit(This* e) {
		cout << "do Up on " << e->thiss().c_str() << endl;
	}
	void visit(That* e) {
		cout << "do Up on " << e->that().c_str() << endl;
	}
	void visit(TheOther* e) {
		cout << "do Up on " << e->theOther().c_str() << endl;
	}
};

class DownVisitor : public Visitor {
	void visit(This* e) {
		cout << "do Down on " << e->thiss().c_str() << endl;
	}
	void visit(That* e) {
		cout << "do Down on " << e->that().c_str() << endl;
	}
	void visit(TheOther* e) {
		cout << "do Down on " << e->theOther().c_str() << endl;
	}
};
